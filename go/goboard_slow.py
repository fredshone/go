...
class  Board():
    ...
    def place_stone(self, player, point):
        ...
        for diff_col_string in adjacent_opposite_color:
            diff_col_string.remove_liberty(point)
        for diff_col_string in adjacent_opposite_color:
            if diff_col_string.num_liberties == 0:
                self._remove_string(diff_col_string)
