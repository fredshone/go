...
class Board:
    ...
    def place_stone(self, player, point):
        ...
        for same_col_string in adjacent_same_color:
            new_string = new_string.merged_with(same_col_string)
        ...
        for other_col_string in adjacent_opposite_color:
            replacement = other_col_string.without_liberty(point)
            if replacement.num_liberties:
                self._replace_string(other_col_string.without_liberty(point))
            else:
                self._remove_string(other_col_string)
